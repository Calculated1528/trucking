    ...
    */
    if(isset($_POST["btn_submit_auth"]) && !empty($_POST["btn_submit_auth"])){
        ...
        if(isset($_POST["captcha"])){
            ...
            $result_query_select = $mysqli->query("SELECT * FROM `client` WHERE email = '".$email."' AND client_password = '".$password."'");
            ...
            exit("<p><strong>Ошибка!</strong> Отсутствует проверочный код, то есть код капчи. Вы можете перейти на главную страницу </p>");
        }
