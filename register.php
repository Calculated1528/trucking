    ...
    if(isset($_POST["btn_submit_register"]) && !empty($_POST["btn_submit_register"])){
        ...
        if(isset($_POST["captcha"]) && !empty($captcha)){
            ...
            if(($_SESSION["rand"] != $captcha) && ($_SESSION["rand"] != "")){
                ...
                if ($_SERVER['HTTP_REFERER'] = "form_register"){
            ...
            if(isset($_POST["client_fname"])){
                
                //Обрезаем пробелы с начала и с конца строки
                $first_name = trim($_POST["client_fname"]);
            ...
            if(isset($_POST["client_lname"])){

                //Обрезаем пробелы с начала и с конца строки
                $last_name = trim($_POST["client_lname"]);
            ...
            if(isset($_POST["email"])){
                ...
                if(!empty($email)){
                    ...
                    $result_query = $mysqli->query("SELECT `email` FROM `client` WHERE `email`='".$email."'");
            ...
            $result_query_insert = $mysqli->query("INSERT INTO `client` (client_fname, client_lname, email, client_password) VALUES ('".$first_name."', '".$last_name."', '".$email."', '".$password."')");
            ...
            exit("<p><strong>Ошибка!</strong> Отсутствует проверечный код, то есть код капчи. Вы можете перейти на главную страницу </p>");
        }
